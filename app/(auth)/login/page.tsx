...
export const metadata = {
  title: 'Sign In | Dimensions',
  description: 'Log in to your Dimensions account to track orders and manage wishlists.'
}

export default async function StoreLoginPage(props: { searchParams?: Promise<any> | any }) {
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between">
                    ...
                    <Link href="/forgot-password" className="text-xs font-medium text-gray-500 hover:text-gray-900 transition-colors">
                      Forgot Password?
                    </Link>
                  </div>
                  <Input 
